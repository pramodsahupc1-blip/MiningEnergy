  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-heading font-bold text-[var(--color-text-primary)]">Deposits</h2>
          <p className="text-[var(--color-text-secondary)]">Manage and approve deposit requests.</p>
        </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {[1, 2, 3].map((_, i) => (
                  <tr key={i} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 font-bold text-green-600">₹500.00</td>
                    <td className="px-6 py-4 text-gray-500">UPI</td>
